package com.preetham.libshare.connectivity;
...
import com.preetham.libshare.AppNotification;
import com.preetham.libshare.EasyHandler;
import com.preetham.libshare.connectivity.listeners.ErrorListener;
import com.preetham.libshare.connectivity.listeners.GroupConnectionListener;
import com.preetham.libshare.connectivity.listeners.GroupCreationListener;
import com.preetham.libshare.connectivity.listeners.GroupMemberListener;
import com.preetham.libshare.connectivity.listeners.NewGroupListener;
import com.preetham.libshare.connectivity.listeners.RequestListener;
import com.preetham.libshare.connectivity.listeners.ResponseListener;
import com.preetham.libshare.music.Song;
import com.preetham.libshare.music.database.Library;
import com.preetham.libshare.services.PlayerService;
...
public class ShareGroup implements NewGroupListener, ErrorListener, GroupMemberListener,
    ...
    private static wifiPlayerGroup currentGroup;
    private String lastJoinedGroupName;
    private ArrayList<wifiPlayerGroup> foundGroups;
    ...
    public class wifiPlayerGroup {
        ...
        public boolean equals(Object obj) {
            return (obj instanceof wifiPlayerGroup
                    && (this.ownerId.equals(((wifiPlayerGroup) obj).ownerId)));
        }

        wifiPlayerGroup(String ownerId, Member owner, String groupName, int memberCount) {
    ...
    public ShareGroup(Context context, String userName, Mode mode){
        ...
        foundGroups = new ArrayList<wifiPlayerGroup>();
        currentGroup = null;
    ...
    public void createGroup(final String groupName, final GroupCreationListener groupCreationListener,
        ...
        isOwner = true;
        currentGroup = new wifiPlayerGroup(null,null,groupName, 1);
    ...
    public ArrayList<wifiPlayerGroup> getGroupList() {
        return foundGroups;
    }
    ...
    public void connectToGroup(int groupListIndex, final GroupConnectionListener connectionListener,
        ...
        GroupConnectionListener connectionListener2 = new GroupConnectionListener() {
            ...
            public void onConnectionSuccess(String connectedGroup) {
                for(wifiPlayerGroup group : foundGroups) {
    ...
    public void newGroupFound(String Id, String groupName, String ownerName, String deviceName, int memberCount) {
        wifiPlayerGroup newGroup = new wifiPlayerGroup(
                Id,
