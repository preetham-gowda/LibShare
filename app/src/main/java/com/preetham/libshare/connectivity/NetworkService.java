...
import com.preetham.libshare.connectivity.listeners.WifiP2pBroadcastReceiver;
...
public class NetworkService extends Service {
    ...
    private final static String INSTANCE_NAME = "player";
        ...
        p2pBroadcastReceiver.registerConnectionInfoListener(
                new WifiP2pManager.ConnectionInfoListener() {
                    ...
                    public void onConnectionInfoAvailable(WifiP2pInfo info) {
                        ...
                        p2pBroadcastReceiver.clearConnectionInfoListener();
